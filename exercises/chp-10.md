...
**01 데이터베이스 설계 단계 중 다음 ( ) 안의 내 용 순서로 옳은 것은?** 답: 3번
...
**02 데이터베이스 물리적 설계 단계에 대한 설명으로 옳은 것은?** 답: 2번
...
**03 물리적 데이터베이스 설계를 위해 고려해야 하는 요소가 아닌 것은?** 답: 2번
...
**05 E-R 모델에서의 〈관계 타입〉 혹은 〈개체 타입〉의 예로 가장 옳은 것은?** 답: 2번
...
**06 다음 E-R 다이어그램을 릴레이션 스키마로 가장 올바르게 변환한 것은?** 답: 3번  
