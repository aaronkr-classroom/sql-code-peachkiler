...
**02 다음 릴레이션에 존재하는 함수 종속성으로 옳은 것은?** 답: 2번
...
**03 데이터의 불필요한 중복으로 인해 발생하는 이상 현상에 속하지 않는 것은?** 답: 1번
...
**04 부분 함수 종속성을 제거함으로써 릴레이션의 모든 속성이 기본키에 완전 함수 종속되는 정규형은?** 답: 3번
...
**05 이행적 함수 종속성을 제거함으로써 릴레이션의 모든 속성들이 기본키에만 종속되는 정규형은?** 답: 4번
...
**06 다음 함수 종속성을 가지는 릴레이션 R은 어떤 정규형에 속하는가?** 답: 2번
...
**07 정규화 과정들을 올바른 순서 대로 나열한 것은?** 답: 1번
...
**08 정규화와 가장 관련성이 높은 릴레이션의 특징은?** 답: 1번
...
**09 정규화와 관련된 설명 중 옳지 않은 것은?** 답: 3번
